...
const Intro = () => {
	return (
		<section className={`intro ${styles.intro}`}>
			<svg className='BgAnimation__svg' viewBox='0 0 602 602' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ position: 'absolute', width: '100%', pointerEvents: 'none' }}>
				<g opacity='0.08'>
					<path
						fillRule='evenodd'
						clipRule='evenodd'
			...
			<h2 className={styles.intro__position}>Front-end Developer</h2>
